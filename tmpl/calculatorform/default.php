...
<div class="calculator-edit front-end-edit">
	...
	<?php else : ?>
		...
		<form id="form-calculator"
			  action="<?php echo Route::_('index.php?option=com_fisc_calculator&task=calculatorform.save'); ?>"
	...
	<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'calculator')); ?>
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'calculator', Text::_('COM_FISC_CALCULATOR_TAB_CALCULATOR', true)); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<a class="btn btn-danger"
					   href="<?php echo Route::_('index.php?option=com_fisc_calculator&task=calculatorform.cancel'); ?>"
